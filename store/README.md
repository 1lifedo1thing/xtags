...
0.1.8 候选资料更新于 2026-09-23。原 0.1.5 运行包不含本次全文分类、提示词边界和 key 隔离改动，**商城只上传本版重新生成的运行包**。GitHub Pages 公开政策随 `main` 的 `/docs` 发布；提交前核对公开页面与随包政策一致。
...
2. **公开隐私政策需要核对。** GitHub Pages 从 `main` 的 `/docs` 发布。推送 0.1.8 后核对中英文政策及支持页可匿名访问，内容与运行包相同，再填写商城 Privacy policy URL。
...
以上地址在原版中已于 2026-09-20 验证匿名访问成功；0.1.8 发布后仍须再次核对线上内容。
